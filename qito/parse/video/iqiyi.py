...
class Main(template.Template):
    ...
    def parse1(self):
        ...
        src = "01080031010000000000"
        # k_ft1 = '18141941858304'  # mp4
        # k_ft1 = "755914244096"  # m3u8
        iqiyiBid = 620
        dashParams = {
            "tvid": tvid,
            "bid": iqiyiBid,
        ...
        fmtDict = {"f4v": [], "ts": [], "265ts": [], "dash": []}
        # 未加载cookie时,判断是不是vip
        if not self.cookie and data["data"].get("boss_ts"):
            raise NotImplementedError(data["data"]["boss_ts"]["msg"])
        ...
        if bid != iqiyiBid:
            ...
            if fmt == "f4v":
                dashParams = {
                    ...
                    "ost": "0",
                    "locale": "zh_cn",
                    "dfp": "e0872a0f57377c495ba863d6b903438fa99e68573ad19f8214edae532ec9b6de0d",
                    "k_tag": "1",
                    "k_ft1": "755914244096",
                    "k_ft5": "1",
                    "k_err_retries": "0",
            ...
            print(url)
            data = self.loads(html)
        self.logging.debug(f"getVideo: {data} \r\n")
        if p.get("encoder") == "h265":
            lists = {
                100: "H265_极速",
                200: "H265_流畅",
    ...
    def cmd5x(self, dash):
        ...
        js = self.read(self.abspath + "/javascript/iqiyi.cmd5x.js")
